...
# information.
#
# deb-reversion copyright 2004-5 by martin f. krafft <madduck@debian.org>
# contributors: Goswin von Brederlow, Filippo Giunchedi
# Modifications copyright 2006 by Julian Gilbey <jdg@debian.org>
#
# TODO: 
...
{
    cat <<EOF
$PROGNAME -- a script to bump a .deb file's version number.
EOF
}
...
{
    cat <<EOF
$PROGNAME is Copyright 2004-5 by martin f. krafft <madduck@debian.org>.
Modifications are Copyright 2006 by Julian Gilbey <jdg@debian.org>.
